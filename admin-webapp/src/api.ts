// The payments-api client — same-origin `/api`, generated from its
// openapi.yaml (src/generated/payments-api.ts). Authorization is entirely
// src/authz/client.ts's: this middleware attaches the bearer and applies the
// 401 rule, and nothing here re-implements either.

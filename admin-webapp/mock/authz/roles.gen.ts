...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Merchant", grants: ["balance:read", "merchants:manage", "payment-links:create", "payment-links:read", "payouts:create", "payouts:read", "refunds:create", "transactions:read"] },
  { name: "PlatformAdmin", grants: ["disputes:read-all", "disputes:resolve", "merchants:read-all", "merchants:review", "payouts:read-all", "payouts:resolve", "transactions:read-all"] },
];

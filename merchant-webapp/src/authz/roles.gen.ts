...
export const SCOPES: readonly Scope[] = ["balance:read", "disputes:read-all", "disputes:resolve", "merchants:manage", "merchants:read-all", "merchants:review", "payment-links:create", "payment-links:read", "payouts:create", "payouts:read", "payouts:read-all", "payouts:resolve", "refunds:create", "transactions:read", "transactions:read-all"];
...
export const ROLE_GRANTS: Record<Role, readonly Scope[]> = {
  "Merchant": ["balance:read", "merchants:manage", "payment-links:create", "payment-links:read", "payouts:create", "payouts:read", "refunds:create", "transactions:read"],
  "PlatformAdmin": ["disputes:read-all", "disputes:resolve", "merchants:read-all", "merchants:review", "payouts:read-all", "payouts:resolve", "transactions:read-all"],
};
